                    ...
                    default: {
                      colors: {
                        ...
                        default: {
                          ...
                          buttonBackground: 'rgba(81, 57, 237, 0.95)',
                          buttonBorder: 'rgba(255, 255, 255, 0.2)',
                          buttonText: '#ffffff',
                          anchorText: 'rgba(255, 255, 255, 0.95)',
                      ...
                      space: {
                        inputPadding: '20px',
                        buttonPadding: '18px 28px',
                      },
                    },
                  },
                  elements: {
                    inputWrapper: 'relative bg-white/10 backdrop-blur-xl rounded-3xl border border-white/20 p-1 hover:border-white/30 transition-all duration-300',
                    input: {
                      ...
                      '&:focus': {
                        outline: 'none',
                        borderColor: 'rgba(81, 57, 237, 0.8)',
                        backgroundColor: 'rgba(255, 255, 255, 0.2)',
                        boxShadow: '0 0 0 4px rgba(81, 57, 237, 0.2), inset 0 1px 0 rgba(255, 255, 255, 0.2)',
                    ...
                    button: {
                      ...
                      borderRadius: '16px',
                      background: 'linear-gradient(135deg, #5139ed 0%, #5a40f3 50%, #6742f6 100%)',
                      backdropFilter: 'blur(20px)',
                      border: '1px solid rgba(255, 255, 255, 0.2)',
                      boxShadow: '0 8px 32px rgba(81, 57, 237, 0.4), inset 0 1px 0 rgba(255, 255, 255, 0.2)',
                      transition: 'all 0.4s cubic-bezier(0.4, 0, 0.2, 1)',
                      padding: '18px 28px',
                      fontSize: '16px',
                      '&:hover': {
                        transform: 'translateY(-2px)',
                        boxShadow: '0 12px 40px rgba(81, 57, 237, 0.6), inset 0 1px 0 rgba(255, 255, 255, 0.3)',
                      },
                      '&:active': {
                        transform: 'translateY(-1px)',
                      },
                    ...
                    anchor: {
                      ...
                      '&:hover': {
                        background: 'rgba(81, 57, 237, 0.2)',
                        borderColor: 'rgba(81, 57, 237, 0.4)',
                        transform: 'translateY(-1px)',
                        boxShadow: '0 4px 12px rgba(81, 57, 237, 0.3)',
                      },
                    },
                    divider: {
